...
export default function DevisComponent() {
    ...
    return (
        <>
            ...
            <div className="flex flex-col md:flex md:flex-row gap-4 my-20 px-4 animate__animated animate__fadeIn">
                        ...
                        <form className="POST" autoComplete="off" onSubmit={()=>handleSubmit}>
                            {
                                !switchDiv ? (
                                    ...
                                    <input type="text" name="name" id="name" placeholder="Raison sociale" className="w-full py-3 px-4 bg-gray-600 outline-none rounded-md text-colorWhite placeholder-colorWhite focus:border-[2px] focus:border-colorOrange transition-all" />
                                ) : (
                                    <input type="text" name="name" id="name" placeholder="Nom Complet" className="w-full py-3 px-4 bg-gray-600 outline-none rounded-md text-colorWhite placeholder-colorWhite focus:border-[2px] focus:border-colorOrange transition-all" />

                                )
                            }

                            <div className="flex flex-col md:grid grid-cols-2 gap-4 md:gap-6">
                                <input type="tel" name="tel" id="tel" placeholder="Numéro de téléphone" className="w-full py-3 px-4 bg-gray-600 outline-none mt-6 rounded-md text-colorWhite placeholder-colorWhite focus:border-[2px] focus:border-colorOrange transition-all" />

                                <input type="email" name="email" id="email" placeholder="Adresse e-mail" className="w-full py-3 px-4 bg-gray-600 outline-none mt-6 rounded-md text-colorWhite placeholder-colorWhite focus:border-[2px] focus:border-colorOrange transition-all" />
                            </div>
...

                            {
                                !switchDiv && (
                                    ...
                                    <input type="text" name="adresse" id="adresse" placeholder="Adresse" className="w-full py-3 px-4  bg-gray-600 outline-none mt-6 rounded-md text-colorWhite placeholder-colorWhite focus:border-[2px] focus:border-colorOrange transition-all" />
                                )
                            }

                            <input type="text" name="titre" id="titre" placeholder="Quel service sollicitez-vous ?" className="w-full py-3 px-4 mt-6 bg-gray-600 outline-none rounded-md text-colorWhite placeholder-colorWhite focus:border-[2px] focus:border-colorOrange transition-all" />

                            <textarea rows={5} name="" id="" className="w-full my-6 px-2 py-3 bg-gray-600 placeholder-colorWhite text-colorWhite rounded-md focus:border-[2px] focus:border-colorOrange transition-all" placeholder="Décrivez votre besoin en quelques lignes."></textarea>
