...
export default function Hero(){
  return(
    <>
      <div className="flex justify-center items-center w-full h-[500px] md:h-[800px] overflow-hidden bg-no-repeat bg-cover bg-center" style={{backgroundImage : "url('/assets/hero1.4.jpg')"}}>
        ...
        <div className="absolute flex flex-col justify-center items-center md:items-start md:ml-24">
          <h4 className="text-2xl text-center text-colorWhite md:text-[50px] font-bold mb-5 text-shadow-lg animate__animated animate__bounce merienda-font">MBOKO-TECHNOLOGY</h4>
