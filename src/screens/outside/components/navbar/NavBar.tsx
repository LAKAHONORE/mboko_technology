  ...
  return (
    <>
      <nav className="flex flex-row w-full h-16 top-0 sticky bg-colorDark justify-between items-center px-4 z-50">
        ...
        <div className={`fixed top-16 bg-colorDark z-20 w-[100%] h-full animate__animated animate__slideInLeft duration-500 ${
                          mobileNav ? "right-0 opacity-100" : "right-[100%] opacity-0"
        }`}>
