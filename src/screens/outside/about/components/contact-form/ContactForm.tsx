          ...
          <div className="block w-full md:flex flex-col shadow-lg shadow-shadowColor h-[600px] md:w-1/3 p-5">
            ...
            <div className="flex flex-row gap-4 mt-8">
              ...
              <div className="flex flex-col text-colorDark dark:text-colorWhite">
                ...
                <Link to={'mailto:contact@mbokotechnology.com'}>contact@mbokotechnology.com</Link>
              </div>
            </div>
            ...
            <form action="">
              <div className="flex flex-col md:grid grid-cols-2 gap-4 md:gap-6">
                  <div className="flex flex-col">
                    <label className="text-colorDark dark:text-colorWhite text-sm md:text-xl">Nom :</label>
                    <input 
                      className="p-2 md:p-4 outline-none shadow-lg bg-[#f1f1f1] dark:bg-gray-900 shadow-shadowColor text-colorDark dark:text-colorWhite placeholder:text-sm placeholder-colorDark dark:placeholder-gray-300 md:my-5 rounded-md focus:border-[2px] focus:border-colorOrange transition-all"
                      type="text"
                      value={name}
                  ...
                  <div className="flex flex-col">
                    <label className="text-colorDark dark:text-colorWhite text-sm md:text-xl">Adresse email :</label>
                    <input 
                      className="p-2 md:p-4 outline-none shadow-lg bg-[#f1f1f1] dark:bg-gray-900 shadow-shadowColor text-colorDark dark:text-colorWhite placeholder:text-sm placeholder-colorDark dark:placeholder-gray-300 md:my-5 rounded-md focus:border-[2px] focus:border-colorOrange transition-all"
                      type="text" 
                      value={email}
              ...
              <div className="flex flex-col md:grid grid-cols-2 gap-4 md:gap-6 mt-6">
                  <div className="flex flex-col">
                    <label className="text-colorDark dark:text-colorWhite text-sm md:text-xl">Numéro de téléphone :</label>
                    <input 
                      className="p-2 md:p-4 outline-none shadow-lg bg-[#f1f1f1] dark:bg-gray-900 shadow-shadowColor text-colorDark dark:text-colorWhite placeholder:text-sm placeholder-colorDark dark:placeholder-gray-300 md:my-5 rounded-md focus:border-[2px] focus:border-colorOrange transition-all"
                      type="text"
                      value={phone} 
                  ...
                  <div className="flex flex-col">
                    <label className="text-colorDark dark:text-colorWhite text-sm md:text-xl">Objet :</label>
                    <input 
                      className="p-2 md:p-4 outline-none shadow-lg bg-[#f1f1f1] dark:bg-gray-900 shadow-shadowColor text-colorDark dark:text-colorWhite placeholder:text-sm placeholder-colorDark dark:placeholder-gray-300 md:my-5 rounded-md focus:border-[2px] focus:border-colorOrange transition-all"
              ...
              <div className="mt-4 flex flex-col md:grid grid-cols-1">
                  <div className="flex flex-col">
                    <label className="text-colorDark dark:text-colorWhite text-sm md:text-xl">Message :</label>
              ...
              <div className="flex flex-row justify-center items-center mt-5">
                  <button 
                    className="bg-colorOrange py-2 px-6 text-colorDark dark:text-colorWhite hover:bg-colorWhite hover:border-[1px] hover:border-colorOrange hover:text-colorOrange dark:hover:text-colorOrange rounded-md transition-all"
